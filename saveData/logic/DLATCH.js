...
let output = {
output0: this.NOR4.compute(this.NOR3.compute(this.AND5.compute(input0, input1).output0, this.NOR4.lastOutput?.output0).output0, this.AND6.compute(input1, this.NOT7.compute(input0).output0).output0).output0
};
